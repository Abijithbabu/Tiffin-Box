...
export default function HomePage() {
  return (
    <main className="relative h-full w-full bg-[#090909] font-jakarta text-white">
      <div className="flex h-full w-full flex-col items-center justify-center md:px-8 lg:px-12 2xl:px-20">
        <Navbar />
        <Hero />
        <AboutUs />
        <Special />
      ...
      <Footer />
      <div className="fixed right-8 top-1/2 hidden -translate-y-1/2 transform md:flex lg:right-12 2xl:right-20">
        <ViewMenu />
      </div>
      <div className="fixed left-8 top-1/2 hidden -translate-y-1/2 transform md:flex lg:left-12 2xl:left-20">
        <Scrollbar />
      </div>
    </main>
  );
