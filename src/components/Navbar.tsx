...
const Navbar = ({ position = "static" }: { position?: "static" | "fixed" }) => {
  ...
  return (
    <nav
      className={cn(
        "absolute top-0 z-50 px-2 md:px-40 pt-1 flex w-full items-center transition-all duration-300 ease-in-out",
    ...
    >
      <div className="flex h-full w-full items-center justify-between">
        ...
        <Button
          className="group text-xs md:text-sm bg-yellow items-center gap-[1.19rem] font-semibold text-black hover:text-[#282828] border border-black hover:bg-primary"
          variant="secondary"
          asChild
        >
          <Link href="/menu">
